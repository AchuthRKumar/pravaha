...
const AnnouncementDetailModal = ({ announcement, onClose }) => {
  ...
  return (
    // Overlay: Fixed to cover whole screen, semi-transparent black background
    <div
    ...
    >
      {/* Modal Content Card */}
      <div
        className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl bg-gradient-to-br from-slate-800/90 via-gray-900/90 to-gray-800/90 border border-white/10 !p-6 md:p-10 text-white animate-fade-in-up flex flex-col gap-y-6"
      ...
      >
        ...
        {/* Company & AI Analysis Header */}
        <div className="flex flex-col gap-y-2">
          <h2 className="text-4xl font-extrabold text-blue-300 tracking-tight">
            {announcement.company_name} <span className="text-2xl font-semibold">({announcement.symbol})</span>
          </h2>
          <h3 className="text-2xl font-bold text-white mt-2">AI Analysis</h3>
        </div>

        {/* Classification, Sentiment, Time */}
